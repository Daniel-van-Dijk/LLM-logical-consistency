...
def get_args_parser():
    ...
    task_list = ['comparative-1', 'temporal-1']
    ...
    parser.add_argument('--batch_size', default=1, type=int, metavar='BATCH_SIZE',
                        help='batch size for inference')
    return parser


def run_tasks(tasks: List[str], model_name: str, output_dir: str, batch_size: int):
...
if __name__ == "__main__":
    ...
    average_accuracy = run_tasks(args.task, args.model, args.output_dir, args.batch_size)
