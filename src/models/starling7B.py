...
class Starling7B:
    ...
    def inference_for_prompt(self, prompt: List[Dict[str, str]]) -> str:
        ...
        generated_ids = self.model.generate(input_ids, max_new_tokens=300, do_sample=True, pad_token_id=self.tokenizer.eos_token_id, output_logits = True, return_dict_in_generate=True)  # no eos_token_id?
